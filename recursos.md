...
<div class="page-header">
    <div class="container">
        <h1><i class="fas fa-link"></i> Recursos e Links Úteis</h1>
        <p class="page-subtitle">Fontes credíveis, instituições oficiais e recursos educacionais</p>
    </div>
</div>
...
.associacao-card {
    ...
    border-radius: 12px;
    box-shadow: 0 2px 8px rgba(0,0,0,0.1);
    border-top: 4px solid var(--amarelo-fruto);
}
